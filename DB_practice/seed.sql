BEGIN IMMEDIATE;
-- ===== シード =====
INSERT INTO customers(id, name, email, region, joined_at)
VALUES (
        1,
        'Alice',
        'alice@example.com',
...
VALUES (1, 'Coffee Beans 250g', 'drink', 900),
...
INSERT INTO orders(id, customer_id, order_date, status, coupon_code)
VALUES (101, 1, '2025-06-01', 'paid', NULL),
